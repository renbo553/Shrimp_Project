                    ...
                    <table class="table">
                            ...
                            <td colspan = "3">             
                                <!-- <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio1_M1" id="radio1_M1_1" type="radio" class="custom-control-input" value="公蝦缸"
                                        checked="checked">
                                    <label for="radio1_M1_1" class="custom-control-label">&emsp;&emsp;公蝦缸</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio1_M1" id="radio1_M1_2" type="radio" class="custom-control-input"
                                        value="母蝦缸">
                                    <label for="radio1_M1_2" class="custom-control-label">&emsp;&emsp;母蝦缸</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio1_M1" id="radio1_M1_3" type="radio" class="custom-control-input"
                                        value="交配缸">
                                    <label for="radio1_M1_3" class="custom-control-label">&emsp;&emsp;交配缸</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio1_M1" id="radio1_M1_4" type="radio" class="custom-control-input"
                                        value="休養缸">
                                    <label for="radio1_M1_4" class="custom-control-label">&emsp;&emsp;休養缸</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio1_M1" id="radio1_M1_5" type="radio" class="custom-control-input"
                                        value="公蝦+母蝦缸">
                                    <label for="radio1_M1_5" class="custom-control-label">&emsp;&emsp;公蝦+母蝦缸</label>
                                </div> -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="total_weight_M1" name="total_weight_M1" type="text" class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="male_shrimp_M1" name="male_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="female_shrimp_M1" name="female_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">隻</div>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="dead_male_shrimp_M1" name="dead_male_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">隻</div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="dead_female_shrimp_M1" name="dead_female_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">隻</div>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="peeling_male_shrimp_M1" name="peeling_male_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">隻</div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="peeling_female_shrimp_M1" name="peeling_female_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">隻</div>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="avg_male_shrimp_M1" name="avg_male_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">(g)</div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="avg_female_shrimp_M1" name="avg_female_shrimp_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">(g)</div>
                                    </div>
                                </div>
                        ...
                        <tr>
                            ...
                            <td colspan = "3">
                                <!-- <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio2_M1" id="radio2_time0900_M1" type="radio" class="custom-control-input" value="9:00"
                                        checked="checked">
                                    <label for="radio2_time0900_M1" class="custom-control-label">&emsp;&emsp;9:00</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio2_M1" id="radio2_time1100_M1" type="radio" class="custom-control-input" value="11:00">
                                    <label for="radio2_time1100_M1" class="custom-control-label">&emsp;&emsp;11:00</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio2_M1" id="radio2_time1400_M1" type="radio" class="custom-control-input" value="14:00">
                                    <label for="radio2_time1400_M1" class="custom-control-label">&emsp;&emsp;14:00</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio2_M1" id="radio2_time1600_M1" type="radio" class="custom-control-input" value="16:00">
                                    <label for="radio2_time1600_M1" class="custom-control-label">&emsp;&emsp;16:00</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio2_M1" id="radio2_time1900_M1" type="radio" class="custom-control-input" value="19:00">
                                    <label for="radio2_time1900_M1" class="custom-control-label">&emsp;&emsp;19:00</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio2_M1" id="radio2_time2300_M1" type="radio" class="custom-control-input" value="23:00">
                                    <label for="radio2_time2300_M1" class="custom-control-label">&emsp;&emsp;23:00</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="radio2_M1" id="radio2_time0300_M1" type="radio" class="custom-control-input" value="3:00">
                                    <label for="radio2_time0300_M1" class="custom-control-label">&emsp;&emsp;3:00</label>
                                </div> -->
                        ...
                        <tr>
                            ...
                            <td colspan = "3">
                                <!-- <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_0_M1" type="checkbox"
                                        class="custom-control-input" value="Polychaete">
                                    <label for="checkbox0900_0_M1" class="custom-control-label">&emsp;&emsp;Polychaete</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_1_M1" type="checkbox"
                                        class="custom-control-input" value="Crab(去殼)">
                                    <label for="checkbox0900_1_M1" class="custom-control-label">&emsp;&emsp;Crab(去殼)</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_2_M1" type="checkbox"
                                        class="custom-control-input" value="Squid">
                                    <label for="checkbox0900_2_M1" class="custom-control-label">&emsp;&emsp;Squid</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_3_M1" type="checkbox"
                                        class="custom-control-input" value="Mussel">
                                    <label for="checkbox0900_3_M1" class="custom-control-label">&emsp;&emsp;Mussel</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_4_M1" type="checkbox"
                                        class="custom-control-input" value="Epsilon">
                                    <label for="checkbox0900_4_M1" class="custom-control-label">&emsp;&emsp;Epsilon</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_5_M1" type="checkbox"
                                        class="custom-control-input" value="日本飼料">
                                    <label for="checkbox0900_5_M1" class="custom-control-label">&emsp;&emsp;日本飼料</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_6_M1" type="checkbox"
                                        class="custom-control-input" value="Krill">
                                    <label for="checkbox0900_6_M1" class="custom-control-label">&emsp;&emsp;Krill</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_7_M1" type="checkbox"
                                        class="custom-control-input" value="Clam(母)">
                                    <label for="checkbox0900_7_M1" class="custom-control-label">&emsp;&emsp;Clam(母)</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_8_M1" type="checkbox"
                                        class="custom-control-input" value="Ezmate(海膽+蟹卵)">
                                    <label for="checkbox0900_8_M1"
                                        class="custom-control-label">&emsp;&emsp;Ezmate(海膽+蟹卵)</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_9_M1" type="checkbox"
                                        class="custom-control-input" value="Ezmate(海膽+蟹白)">
                                    <label for="checkbox0900_9_M1"
                                        class="custom-control-label">&emsp;&emsp;Ezmate(海膽+蟹白)</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_10_M1" type="checkbox"
                                        class="custom-control-input" value="Ezmate(海膽+蟹黃)">
                                    <label for="checkbox0900_10_M1"
                                        class="custom-control-label">&emsp;&emsp;Ezmate(海膽+蟹黃)</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_11_M1" type="checkbox"
                                        class="custom-control-input" value="Ezmate(海膽)">
                                    <label for="checkbox0900_11_M1" class="custom-control-label">&emsp;&emsp;Ezmate(海膽)</label>
                                </div>
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input name="food0900" id="checkbox0900_12_M1" type="checkbox"
                                        class="custom-control-input" value="other" onchange="setClick_M1();">
                                    <label for="checkbox0900_12_M1" class="custom-control-label">&emsp;&emsp;其他&emsp;</label>
                                    <input disabled="disabled" for="checkbox0900_12_M1" type="text" name="checkbox0900_other_M1" id="checkbox_other09_M1">
                                </div> -->
                                <select id="select_time" name="time" class="custom-select">
                                    <option value="none" selected disabled hidden></option>
                                    <option value=""></option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="weight0900_M1" name="weight0900_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">(g)</div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <input id="remain0900_M1" name="remain0900_M1" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <div class="input-group-text">(g)</div>
                                    </div>
                                </div>
